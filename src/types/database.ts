...
export type Database = {
  ...
  public: {
        ...
        Relationships: [
          {
            ...
            columns: ['packaging'];
            isOneToOne: false;
            referencedRelation: 'product_packaging_normal_price_view';
      ...
      ProductSellContextPrice: {
        ...
        Relationships: [
          ...
          },
          {
            ...
            columns: ['sell_context'];
            isOneToOne: false;
            referencedRelation: 'sellcontext_view';
            referencedColumns: ['sellcontext_id'];
          },
        ];
      };
      ProductSpecs: {
    ...
    Functions: {
      count_sellcontext_for_typesense: {
        Args: Record<PropertyKey, never>;
        Returns: number;
      };
      get_sellcontext_for_typesense: {
