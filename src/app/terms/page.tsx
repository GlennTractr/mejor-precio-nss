          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 my-4">
              <p className="text-gray-700">
                <strong>Important:</strong> At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti.
              </p>
            </div>
          </div>
        </section>
              ...
              <table className="w-full border-collapse border border-gray-300 text-sm">
                <thead>
                  <tr className="bg-gray-50">
                    <th className="border border-gray-300 px-4 py-2 text-left font-medium text-accent">Service Type</th>
                    <th className="border border-gray-300 px-4 py-2 text-left font-medium text-accent">Billing Period</th>
                    <th className="border border-gray-300 px-4 py-2 text-left font-medium text-accent">Cancellation</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
        ...
        <section className="space-y-4">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="bg-red-50 border-l-4 border-red-400 p-4 my-4">
              <p className="text-gray-700">
                <strong>Disclaimer:</strong> Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur.
              </p>
            </div>
            
            <ul className="list-disc list-inside text-gray-700 space-y-2">
              <li><strong>Service Availability:</strong> Lorem ipsum dolor sit amet</li>
              <li><strong>Data Accuracy:</strong> Consectetur adipiscing elit, sed do</li>
              <li><strong>Third-party Links:</strong> Eiusmod tempor incididunt ut labore</li>
              <li><strong>Service Interruptions:</strong> Et dolore magna aliqua ut enim</li>
            </ul>
          </div>
        </section>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="space-y-2">
                <p className="text-gray-700"><strong>Legal Department:</strong> legal@mejorprecio.com</p>
                <p className="text-gray-700"><strong>General Inquiries:</strong> support@mejorprecio.com</p>
