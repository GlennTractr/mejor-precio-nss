  ...
  return (
    <div className="mx-auto max-w-4xl p-6 my-6">
      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="prose prose-gray max-w-none space-y-4">
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              <li>Buscar y comparar precios de productos para bebé de diferentes tiendas</li>
              <li>Crear listas de favoritos y alertas de precios</li>
              <li>Acceder a información de productos y reseñas</li>
              <li>Compartir información útil sobre productos para bebé</li>
            </ul>
            ...
            <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
              ...
              <li>Intentar dañar, hackear o interferir con el funcionamiento del sitio</li>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white rounded-lg border border-secondary/20 p-4 shadow-sm">
                ...
                <p className="text-gray-700 text-sm">
                  Mantenga su contraseña segura y notifique cualquier uso no autorizado de su cuenta
        ...
        <section className="space-y-4">
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 leading-relaxed mb-4">
              ...
              nuestros usuarios hagan lo mismo. Todo el contenido en nuestro sitio está protegido
            ...
            <p className="text-gray-700 leading-relaxed">
              Todos los derechos sobre el diseño, texto, gráficos, código y otros materiales de
              SaveOnBaby son propiedad exclusiva de SaveOnBaby o están utilizados bajo licencia.
            </p>
          </div>
        </section>
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <div className="overflow-x-auto">
              <table className="w-full border-collapse border border-gray-300 text-sm">
                ...
                <tbody>
                  <tr>
                    <td className="border border-gray-300 px-4 py-2">Servicio Básico</td>
                    <td className="border border-gray-300 px-4 py-2">Gratuito</td>
                    <td className="border border-gray-300 px-4 py-2">Comparación de precios</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="border border-gray-300 px-4 py-2">Según disponibilidad</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-accent mb-4">7. Terminación del Servicio</h2>
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <p className="text-gray-700 leading-relaxed">
              En caso de terminación, las disposiciones de estos términos que por su naturaleza
              deban sobrevivir la terminación, incluyendo limitaciones de responsabilidad y
              disposiciones de propiedad intelectual, continuarán en vigor.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          <h2 className="text-xl font-semibold text-accent mb-4">10. Información de Contacto</h2>
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-700 leading-relaxed mb-4">
              Si tiene preguntas sobre estos Términos y Condiciones o necesita soporte con nuestros
              servicios, puede contactarnos a través de los siguientes medios:
            </p>
            ...
            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
              <div className="space-y-2">
                ...
                <p className="text-gray-700">
                  <strong>Horario de Atención:</strong> Lunes a Viernes, 9:00 - 18:00 hrs (GMT-6)
                </p>
              </div>
            </div>
          </div>
